...
export const allShopItems: ShopItem[] = [
  ...
  { name: "$100 Walking Pad Grant", price: 20, img: "/prizes/walking_pad.jpg", description: "get your steps in while grinding" },
  ...
  { name: "Fitbit Air", price: 33, img: "/prizes/fitbit.jpg", description: "track your health so you don't sit all day" },
